...
public class TC_Adjust_Card_MasterCard2BIN {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		/*try{
			...
			browser.excel.storeCellData("VTAdjust_CardReports", "text::"+txtTxnID, 8, 8);
			...
			browser.excel.storeCellData("VTAdjust_CardReports", "text::"+txtCardNumber, 8, 10);
			...
			browser.excel.storeCellData("VTAdjust_CardReports", "text::"+txtPaymentType, 8, 11);
			...
			browser.excel.storeCellData("VTAdjust_CardReports", "text::"+txtDateTime, 8, 7);
