...
public class TC_TxnDetailReport_Auth_Token_AMEX_Level2 {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		txndtlrprt.vtRequestCardToken(16, browser, logresult);
		Thread.sleep(1000);
		...
		txndtlrprt.vtLevel2(6, browser, logresult);
		Thread.sleep(10000);
		...
		txndtlrprt.txnDetailReportLevel2(6, browser, logresult);
		Thread.sleep(1000);
