...
public class TC_Sale_Multiple_Refund_Visa {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		vt.vtRefund(16, browser, logresult);
		Thread.sleep(1000);
		...
		/*try{
			...
			browser.excel.storeCellData("VTRefund_Dashboard", "text::"+txtTxnID, 8, 3);
			browser.excel.storeCellData("VTRefund_CardReports", txtTxnID, 5, 5);
			browser.excel.storeCellData("VTRefund_CardReports", "text::"+txtTxnID, 12, 8);
			...
			browser.excel.storeCellData("VTRefund_Dashboard", "text::"+txtCardNumber, 8, 2);
			browser.excel.storeCellData("VTRefund_CardReports", "text::"+txtCardNumber, 12, 10);
			...
			browser.excel.storeCellData("VTRefund_CardReports", "text::"+txtPaymentType, 12, 11);
			...
			browser.excel.storeCellData("VTRefund_Dashboard", "text::"+txtDate, 8, 5);
			...
			browser.excel.storeCellData("VTRefund_Dashboard", "text::"+txtTime, 8, 6);
			...
			browser.excel.storeCellData("VTRefund_CardReports", "text::"+txtDateTime, 12, 7);
		...
		vt.vtCardReports(12, browser, logresult);
		Thread.sleep(1000);*/
		...
		vt.vtRefund(18, browser, logresult);
		Thread.sleep(1000);
		...
		try{
			...
			txtTxnID = driver.findElement(By.id("transaction_id")).getText();
			browser.excel.storeCellData("VTRefund_Dashboard", "xpath:://table[@class='rtable1']/tbody/tr[*]/td[2][text()='"+txtTxnID+"']", 1, 3);
			browser.excel.storeCellData("VTRefund_Dashboard", "text::"+txtTxnID, 10, 3);
			browser.excel.storeCellData("VTRefund_CardReports", txtTxnID, 5, 5);
			browser.excel.storeCellData("VTRefund_CardReports", "text::"+txtTxnID, 14, 8);
			
			txtCardNumber = driver.findElement(By.xpath("//td[contains(text(),'Card Number')]/../td[2]")).getText();
			browser.excel.storeCellData("VTRefund_Dashboard", "xpath:://table[@class='rtable1']/tbody/tr[*]/td[2][text()='"+txtTxnID+"']/../td[1]", 1, 2);
			browser.excel.storeCellData("VTRefund_Dashboard", "text::"+txtCardNumber, 10, 2);
			browser.excel.storeCellData("VTRefund_CardReports", "text::"+txtCardNumber, 14, 10);
			
			browser.excel.storeCellData("VTRefund_Dashboard", "xpath:://table[@class='rtable1']/tbody/tr[*]/td[2][text()='"+txtTxnID+"']/../td[3]", 1, 4);
			
			txtPaymentType = driver.findElement(By.xpath("//td[contains(text(),'Payment Type')]/../td[2]")).getText();
			browser.excel.storeCellData("VTRefund_CardReports", "text::"+txtPaymentType, 14, 11);
			
			txtDate = driver.findElement(By.xpath("//div[@id='customer_recipt']/table//tbody/tr[8]/td[2]")).getText();
			browser.excel.storeCellData("VTRefund_Dashboard", "xpath:://table[@class='rtable1']/tbody/tr[*]/td[2][text()='"+txtTxnID+"']/../td[4]", 1, 5);
			browser.excel.storeCellData("VTRefund_Dashboard", "text::"+txtDate, 10, 5);
			
			txtTime = driver.findElement(By.xpath("//div[@id='customer_recipt']/table//tbody/tr[9]/td[2]")).getText();
			browser.excel.storeCellData("VTRefund_Dashboard", "xpath:://table[@class='rtable1']/tbody/tr[*]/td[2][text()='"+txtTxnID+"']/../td[5]", 1, 6);
			browser.excel.storeCellData("VTRefund_Dashboard", "text::"+txtTime, 10, 6);
			
			browser.excel.storeCellData("VTRefund_Dashboard", "xpath:://table[@class='rtable1']/tbody/tr[*]/td[2][text()='"+txtTxnID+"']/../td[6]", 1, 7);
			
			txtDateTime = txtDate+" "+txtTime;
			browser.excel.storeCellData("VTRefund_CardReports", "text::"+txtDateTime, 14, 7);
		...
		vt.vtDashboard(10, browser, logresult);
		Thread.sleep(1000);
		...
		vt.vtCardReports(14, browser, logresult);
		Thread.sleep(1000);
