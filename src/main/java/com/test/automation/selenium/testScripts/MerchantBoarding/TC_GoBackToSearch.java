...
public class TC_GoBackToSearch {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		logresult.logTest("Test Execution", "Status", "INFO", "", "Clicking on the 'Go Back To Search' button", "");
		
		mb.searchMerchant(36, browser, logresult);
		Thread.sleep(2000);
