...
public class TC_Customer_AddCustomer_MultipleContract {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		rd.addCustomer(58, browser, logresult);
		Thread.sleep(1000);
		
		rd.multipleContract(4, browser, logresult);
		Thread.sleep(1000);
		
		rd.multipleContract(6, browser, logresult);
		Thread.sleep(1000);
		
		try{
			driver=browser.driver;
			driver.findElement(By.xpath("//div[@id='billingPlan-1']/ul/li[3]/a")).click();
		...
		rd.multipleContract(8, browser, logresult);
		Thread.sleep(1000);
		
		rd.multipleContract(10, browser, logresult);
		Thread.sleep(1000);
