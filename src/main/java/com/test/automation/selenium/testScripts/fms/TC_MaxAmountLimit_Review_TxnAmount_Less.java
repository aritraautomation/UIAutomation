...
public class TC_MaxAmountLimit_Review_TxnAmount_Less {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		fms.maxAmountLimit(22, browser, logresult);
		Thread.sleep(1000);
		...
		fms.maxAmountLimit(24, browser, logresult);
		Thread.sleep(1000);
		
		fms.vtSale(4, browser, logresult);
		Thread.sleep(1000);
		
		fms.vtSale(6, browser, logresult);
		Thread.sleep(1000);
