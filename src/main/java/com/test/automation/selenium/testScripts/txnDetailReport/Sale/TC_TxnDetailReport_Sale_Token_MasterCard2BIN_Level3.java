...
public class TC_TxnDetailReport_Sale_Token_MasterCard2BIN_Level3 {
	...
	String txtTaxCategory = null;
	String txtMeasurementUnit = null;
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		txndtlrprt.vtRequestCardToken(14, browser, logresult);
		Thread.sleep(1000);
		...
		try{
			...
			browser.excel.storeCellData("TxnDetailReportSale_ReportNone", "text::"+txtExpDate, 6, 5);
		...
		try{
			...
			browser.excel.storeCellData("TxnDetailReportSale_ReportNone", "text::"+txtTokenNumber, 6, 16);
		...
		txndtlrprt.vtToken(16, browser, logresult);
		Thread.sleep(1000);
		...
		try{
			...
			if (txtDataSource.equals("MANUAL")){
				...
				browser.excel.storeCellData("TxnDetailReportSale_ReportNone", "text::"+txtDataSource, 6, 11);
			}
			else{
				browser.excel.storeCellData("TxnDetailReportSale_ReportNone", "text::"+txtDataSource, 6, 11);				
			}
		...
		txndtlrprt.vtLevel3(6, browser, logresult);
		Thread.sleep(1000);
		
		try{
			driver=browser.driver;
			
			txtTaxCategory = driver.findElement(By.xpath("//div[@id='taxCategory']/button/div/span")).getText();
			browser.excel.storeCellData("TxnDetailReportSale_ReportL3", "text::"+txtTaxCategory, 6, 4);
			
			txtMeasurementUnit = driver.findElement(By.xpath("//div[@id='measurementUnit']/button/div/span")).getText();
			browser.excel.storeCellData("TxnDetailReportSale_ReportL3", "text::"+txtMeasurementUnit, 6, 18);
		...
		txndtlrprt.vtLevel3(8, browser, logresult);
		Thread.sleep(10000);
		...
		try{
			...
			browser.excel.storeCellData("TxnDetailReportSale_ReportNone", "text::"+txtTxnID, 6, 14);
			...
			browser.excel.storeCellData("TxnDetailReportSale_ReportNone", "text::"+txtCardNumber, 6, 4);
			
			txtDOP = driver.findElement(By.xpath("//td[contains(text(),'Description of purchase')]/../td[2]")).getText();
			browser.excel.storeCellData("TxnDetailReportSale_ReportNone", "text::"+txtDOP, 6, 6);
			
			txtPaymentType = driver.findElement(By.xpath("//td[contains(text(),'Payment Type')]/../td[2]")).getText();
			browser.excel.storeCellData("TxnDetailReportSale_ReportNone", "text::"+txtPaymentType, 6, 7);
			
			txtAuthCode = driver.findElement(By.xpath("//td[contains(text(),'Auth Code')]/../td[2]")).getText();
			browser.excel.storeCellData("TxnDetailReportSale_ReportNone", "text::"+txtAuthCode, 6, 15);
			...
			browser.excel.storeCellData("TxnDetailReportSale_ReportNone", "text::"+txtDateTime, 6, 23);
		...
		txndtlrprt.txnDetailReportLevel3(6, browser, logresult);
		Thread.sleep(1000);
