...
public class TC_StreetAddress_Decline_Unmatched {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		fms.streetAddress(6, browser, logresult);
		Thread.sleep(1000);
		...
		fms.streetAddress(12, browser, logresult);
		Thread.sleep(1000);
		
		fms.vtSale(4, browser, logresult);
		Thread.sleep(1000);
		
		fms.vtSale(24, browser, logresult);
		Thread.sleep(1000);
