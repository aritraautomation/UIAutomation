...
public class TC_TxnDetailReport_ForceCapture_Card_Visa_Level3 {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("TxnDetailReportFC_ReportL3", "text::"+txtTaxCategory, 4, 4);
			
			txtMeasurementUnit = driver.findElement(By.xpath("//div[@id='measurementUnit']/button/div/span")).getText();
			browser.excel.storeCellData("TxnDetailReportFC_ReportL3", "text::"+txtMeasurementUnit, 4, 18);
		...
		try{
			...
			System.out.println("Transaction ID: "+txtTxnID);
