...
public class TC_UploadFile_SelectFile_NonCSV {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		Runtime.getRuntime().exec(strPath + "\\BatchPayDocx.exe");
		Thread.sleep(1000);
		
		bp.uploadFile(8, browser, logresult);
		Thread.sleep(3000);
		
		bp.uploadFile(10, browser, logresult);
		Thread.sleep(1000);
