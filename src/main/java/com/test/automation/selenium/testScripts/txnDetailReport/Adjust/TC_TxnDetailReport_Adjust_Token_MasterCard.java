...
public class TC_TxnDetailReport_Adjust_Token_MasterCard {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("TxnDtlReportAdjust_Report", "text::"+txtExpDate, 6, 5);
		...
		try{
			...
			browser.excel.storeCellData("TxnDtlReportAdjust_Report", "text::"+txtTokenNumber, 6, 16);
		...
		try{
			...
			if (txtDataSource.equals("MANUAL")){
				...
				browser.excel.storeCellData("TxnDtlReportAdjust_Report", "text::"+txtDataSource, 6, 11);
			}
			else{
				browser.excel.storeCellData("TxnDtlReportAdjust_Report", "text::"+txtDataSource, 6, 11);				
			}
		...
		try{
			...
			browser.excel.storeCellData("TxnDtlReportAdjust_Report", "text::"+txtTxnID, 6, 14);
			...
			browser.excel.storeCellData("TxnDtlReportAdjust_Report", "text::"+txtCardNumber, 6, 4);
			
			txtPaymentType = driver.findElement(By.xpath("//td[contains(text(),'Payment Type')]/../td[2]")).getText();
			browser.excel.storeCellData("TxnDtlReportAdjust_Report", "text::"+txtPaymentType, 6, 7);
			
			txtAuthCode = driver.findElement(By.xpath("//td[contains(text(),'Auth Code')]/../td[2]")).getText();
			browser.excel.storeCellData("TxnDtlReportAdjust_Report", "text::"+txtAuthCode, 6, 15);
			...
			browser.excel.storeCellData("TxnDtlReportAdjust_Report", "text::"+txtDateTime, 6, 23);
