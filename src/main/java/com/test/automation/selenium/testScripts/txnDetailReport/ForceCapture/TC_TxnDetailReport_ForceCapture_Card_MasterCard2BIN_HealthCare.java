...
public class TC_TxnDetailReport_ForceCapture_Card_MasterCard2BIN_HealthCare {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("TxnDetailReportFC_ReportHC", "text::"+txtHealthCareAccountType, 6, 3);
			
			txtPOSQualified = driver.findElement(By.xpath("//div[@id='posQualifiedList']/button/div/span")).getText();
			browser.excel.storeCellData("TxnDetailReportFC_ReportHC", "text::"+txtPOSQualified, 6, 7);
