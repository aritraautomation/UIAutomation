...
public class TC_RequestCardToken_Different_MID_Same_Card {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			token.requestCardToken(32, browser, logresult);
			Thread.sleep(1000);
			...
			if(strTokenNumber1.equals(strTokenNumber2)){
				...
				logresult.logTest("Test Execution", "Status", "INFO", "First Card Token: "+strTokenNumber1+" and Second Card Token: "+strTokenNumber2, "Same Card Token got generated for different MIDs and same Card Number!!!", "");
			}
			
			else{
				
				logresult.logTest("Test Execution", "Status", "INFO", "First Card Token: "+strTokenNumber1+" and Second Card Token: "+strTokenNumber2, "Different Card Tokens got generated for different MIDs and same Card Number!!!", "");
			}
