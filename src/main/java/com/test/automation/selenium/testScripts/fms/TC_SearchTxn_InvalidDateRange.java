...
public class TC_SearchTxn_InvalidDateRange {
	...
	WebElement txtStartDate = null;
	WebElement txtEndDate = null;
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		fms.fmsSearch(28, browser, logresult);
		Thread.sleep(1000);
		
		try{
			driver=browser.driver;
			txtStartDate = driver.findElement(By.id("startDate"));
			txtStartDate.click();
			txtStartDate.sendKeys(Keys.chord(Keys.CONTROL,"a",Keys.DELETE));
			
			txtEndDate = driver.findElement(By.id("endDate"));
			txtEndDate.click();
		...
		fms.fmsSearch(30, browser, logresult);
		Thread.sleep(1000);
