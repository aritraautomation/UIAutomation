...
public class TC_TxnDetailReport_Auth_Card_MasterCard2BIN_Level3 {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("TxnDetailReportAuth_ReportL3", "text::"+txtTaxCategory, 6, 4);
			
			txtMeasurementUnit = driver.findElement(By.xpath("//div[@id='measurementUnit']/button/div/span")).getText();
			browser.excel.storeCellData("TxnDetailReportAuth_ReportL3", "text::"+txtMeasurementUnit, 6, 18);
