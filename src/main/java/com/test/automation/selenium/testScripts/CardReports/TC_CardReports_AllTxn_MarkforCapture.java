...
public class TC_CardReports_AllTxn_MarkforCapture {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		cr.searchTransaction(26, browser, logresult);
		Thread.sleep(1000);
		
		cr.cardReportsCheckButton(12, browser, logresult);
		Thread.sleep(1000);
		
		cr.cardReportsCheckButton(14, browser, logresult);
		Thread.sleep(1000);
		
		cr.cardReportsCheckButton(16, browser, logresult);
		Thread.sleep(1000);
		
		cr.cardReportsCheckButton(18, browser, logresult);
		Thread.sleep(1000);
		
		cr.cardReportsCheckButton(20, browser, logresult);
		Thread.sleep(1000);
