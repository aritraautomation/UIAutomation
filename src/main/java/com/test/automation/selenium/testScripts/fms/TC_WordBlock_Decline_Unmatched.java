...
public class TC_WordBlock_Decline_Unmatched {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		fms.wordBlock(4, browser, logresult);
		Thread.sleep(1000);
		
		fms.wordBlock(6, browser, logresult);
		Thread.sleep(1000);
		
		fms.wordBlock(8, browser, logresult);
		Thread.sleep(1000);
		
		fms.wordBlock(10, browser, logresult);
		Thread.sleep(1000);
		
		fms.wordBlock(12, browser, logresult);
		Thread.sleep(1000);
		
		fms.vtSale(4, browser, logresult);
		Thread.sleep(1000);
		
		fms.vtSale(28, browser, logresult);
		Thread.sleep(1000);
		...
		fms.wordBlock(14, browser, logresult);
		Thread.sleep(1000);
		
		fms.wordBlock(16, browser, logresult);
		Thread.sleep(1000);
		
		fms.wordBlock(18, browser, logresult);
		Thread.sleep(1000);
		
		fms.wordBlock(20, browser, logresult);
		Thread.sleep(1000);
