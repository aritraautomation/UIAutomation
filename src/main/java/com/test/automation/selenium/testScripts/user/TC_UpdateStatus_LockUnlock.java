...
public class TC_UpdateStatus_LockUnlock {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			user.userSearch(16, browser, logresult);
			Thread.sleep(1000);
			
			user.userLockUnlock(4, browser, logresult);
			Thread.sleep(1000);
			
			user.userLockUnlock(6, browser, logresult);
			Thread.sleep(1000);
			
			user.userLockUnlock(8, browser, logresult);
			Thread.sleep(1000);
			
			user.userSearch(18, browser, logresult);
			Thread.sleep(1000);
