...
public class TC_Dashboard_Void {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		vt.vtAuth(16, browser, logresult);
		Thread.sleep(10000);
		...
		try{
			...
			txtTxnID = driver.findElement(By.id("transaction_id")).getText();
			browser.excel.storeCellData("VTRefund_Dashboard", "xpath:://table[contains(@class,'rtable1')]/tbody/tr[*]/td[2][text()='"+txtTxnID+"']", 1, 3);
			...
			browser.excel.storeCellData("VTRefund_CardReports", "text::"+txtTxnID, 8, 8);
			
			txtCardNumber = driver.findElement(By.xpath("//td[contains(text(),'Card Number')]/../td[2]")).getText();
			browser.excel.storeCellData("VTRefund_Dashboard", "xpath:://table[contains(@class,'rtable1')]/tbody/tr[*]/td[2][text()='"+txtTxnID+"']/../td[1]", 1, 2);
			browser.excel.storeCellData("VTRefund_Dashboard", "text::"+txtCardNumber, 6, 2);
			browser.excel.storeCellData("VTRefund_CardReports", "text::"+txtCardNumber, 8, 10);
			
			browser.excel.storeCellData("VTRefund_Dashboard", "xpath:://table[contains(@class,'rtable1')]/tbody/tr[*]/td[2][text()='"+txtTxnID+"']/../td[3]", 1, 4);
			
			txtPaymentType = driver.findElement(By.xpath("//td[contains(text(),'Payment Type')]/../td[2]")).getText();
			browser.excel.storeCellData("VTRefund_CardReports", "text::"+txtPaymentType, 8, 11);
			
			txtDate = driver.findElement(By.xpath("//div[@id='customer_recipt']/table//tbody/tr[8]/td[2]")).getText();
			browser.excel.storeCellData("VTRefund_Dashboard", "xpath:://table[contains(@class,'rtable1')]/tbody/tr[*]/td[2][text()='"+txtTxnID+"']/../td[4]", 1, 5);
			...
			browser.excel.storeCellData("VTRefund_Dashboard", "xpath:://table[contains(@class,'rtable1')]/tbody/tr[*]/td[2][text()='"+txtTxnID+"']/../td[5]", 1, 6);
			browser.excel.storeCellData("VTRefund_Dashboard", "text::"+txtTime, 6, 6);
			
			browser.excel.storeCellData("VTRefund_Dashboard", "xpath:://table[contains(@class,'rtable1')]/tbody/tr[*]/td[2][text()='"+txtTxnID+"']/../td[6]", 1, 7);
			
			txtDateTime = txtDate+" "+txtTime;
			browser.excel.storeCellData("VTRefund_CardReports", "text::"+txtDateTime, 8, 7);
