...
public class TC_UpdateInformation_AllMIDs {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("Message_Add", "xpath:://table[@class='rtable']/tbody/tr[*]/td[1]/span[text()='"+strMessageSubject+"']/../../td[7]/span[2]/span/button", 1, 21);
		...
		msg.addMessage(30, browser, logresult);
		Thread.sleep(1000);
		
		msg.updateMessage(4, browser, logresult);
		Thread.sleep(1000);
		...
		msg.updateMessage(10, browser, logresult);
		Thread.sleep(1000);
