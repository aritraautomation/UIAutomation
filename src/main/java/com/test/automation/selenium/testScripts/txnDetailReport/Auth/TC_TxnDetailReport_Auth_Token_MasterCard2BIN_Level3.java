...
public class TC_TxnDetailReport_Auth_Token_MasterCard2BIN_Level3 {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("TxnDetailReportAuth_ReportNone", "text::"+txtExpDate, 6, 5);
		...
		try{
			...
			browser.excel.storeCellData("TxnDetailReportAuth_ReportNone", "text::"+txtTokenNumber, 6, 16);
		...
		try{
			...
			if (txtDataSource.equals("MANUAL")){
				...
				browser.excel.storeCellData("TxnDetailReportAuth_ReportNone", "text::"+txtDataSource, 6, 11);
			}
			else{
				browser.excel.storeCellData("TxnDetailReportAuth_ReportNone", "text::"+txtDataSource, 6, 11);				
			}
		...
		try{
			...
			browser.excel.storeCellData("TxnDetailReportAuth_ReportNone", "text::"+txtTxnID, 6, 14);
			...
			browser.excel.storeCellData("TxnDetailReportAuth_ReportNone", "text::"+txtCardNumber, 6, 4);
			
			txtDOP = driver.findElement(By.xpath("//td[contains(text(),'Description of purchase')]/../td[2]")).getText();
			browser.excel.storeCellData("TxnDetailReportAuth_ReportNone", "text::"+txtDOP, 6, 6);
			
			txtPaymentType = driver.findElement(By.xpath("//td[contains(text(),'Payment Type')]/../td[2]")).getText();
			browser.excel.storeCellData("TxnDetailReportAuth_ReportNone", "text::"+txtPaymentType, 6, 7);
			
			txtAuthCode = driver.findElement(By.xpath("//td[contains(text(),'Auth Code')]/../td[2]")).getText();
			browser.excel.storeCellData("TxnDetailReportAuth_ReportNone", "text::"+txtAuthCode, 6, 15);
			...
			browser.excel.storeCellData("TxnDetailReportAuth_ReportNone", "text::"+txtDateTime, 6, 23);
