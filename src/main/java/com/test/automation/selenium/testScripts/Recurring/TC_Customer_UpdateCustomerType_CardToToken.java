...
public class TC_Customer_UpdateCustomerType_CardToToken {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("Recurring1_CustomerUpdate", txtTokenNumber, 29, 18);
			Thread.sleep(1000);
			}
			catch(Exception e){
		...
		rd.addCustomer(18, browser, logresult);
		Thread.sleep(1000);
		...
		rd.updateCustomer(30, browser, logresult);
		Thread.sleep(2000);
