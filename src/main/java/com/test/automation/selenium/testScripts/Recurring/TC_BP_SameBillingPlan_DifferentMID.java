...
public class TC_BP_SameBillingPlan_DifferentMID {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("Recurring_BPAdd", txtBillingPlan, 29, 6);
			browser.excel.storeCellData("Recurring_BPSearch", txtBillingPlan, 3, 1);
			browser.excel.storeCellData("Recurring_BPSearch", "text::"+txtBillingPlan, 8, 3);
		...
		rd.searchBillingPlan(8, browser, logresult);
		Thread.sleep(1000);
		
		rd.addBillingPlan(28, browser, logresult);
		Thread.sleep(1000);
		
		rd.addBillingPlan(8, browser, logresult);
		Thread.sleep(1000);
		
		rd.addBillingPlan(30, browser, logresult);
		Thread.sleep(4000);
