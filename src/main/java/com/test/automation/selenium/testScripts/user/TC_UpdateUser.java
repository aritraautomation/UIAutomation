...
public class TC_UpdateUser {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("User_Search", "text::"+txtUsername, 8, 6);
			browser.excel.storeCellData("User_Search", "text::"+txtUsername, 20, 6);
			browser.excel.storeCellData("User_Detail", "valueattribute::"+txtUsername, 4, 2);
			browser.excel.storeCellData("User_Detail", "valueattribute::"+txtUsername, 14, 2);
			...
			user.userSearch(8, browser, logresult);
			Thread.sleep(1000);
			...
			user.verifyUserDetail(6, browser, logresult);
			Thread.sleep(1000);
			
			user.userUpdate(4, browser, logresult);
			Thread.sleep(1000);
			...
			try{
				...
				txtUserLevel = driver.findElement(By.xpath("//div[@id='userCategoryId']/button/div/span")).getText();
				browser.excel.storeCellData("User_Detail", "text::"+txtUserLevel, 14, 4);
			...
			user.userUpdate(6, browser, logresult);
			Thread.sleep(1000);
			
			user.userUpdate(8, browser, logresult);
			Thread.sleep(1000);
			
			user.userUpdate(10, browser, logresult);
			Thread.sleep(1000);
			
			user.verifyUserDetail(14, browser, logresult);
			Thread.sleep(1000);
			
			user.userSearch(6, browser, logresult);
			Thread.sleep(1000);
			
			user.userSearch(20, browser, logresult);
			Thread.sleep(1000);
