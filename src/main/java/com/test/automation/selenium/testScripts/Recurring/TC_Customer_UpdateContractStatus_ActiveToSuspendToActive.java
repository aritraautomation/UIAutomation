...
public class TC_Customer_UpdateContractStatus_ActiveToSuspendToActive {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		rd.addCustomer(16, browser, logresult);
		Thread.sleep(1000);
		...
		rd.updateCustomer(14, browser, logresult);
		Thread.sleep(2000);
		
		rd.updateCustomer(16, browser, logresult);
		Thread.sleep(2000);
		...
		rd.updateCustomer(18, browser, logresult);
		Thread.sleep(2000);
		
		rd.updateCustomer(20, browser, logresult);
		Thread.sleep(2000);
