...
public class TC_Notice_UpdateNotice {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("Recurring1_NoticeAdd", txtContractNo, 7, 3);
			...
			browser.excel.storeCellData("Recurring1_NoticeUpdate", "valueattribute::"+txtContractNo, 4, 1);
			browser.excel.storeCellData("Recurring1_NoticeUpdate", "valueattribute::"+txtContractNo, 12, 1);
			Thread.sleep(1000);
			}
			catch(Exception e){
				logresult.logTest("Test Execution", "Status", "INFO", "Exception occurred!!!", e.getMessage(), "");
		...
		rd.addNotice(8, browser, logresult);
		Thread.sleep(3000);
		
		/*rd.searchNotice(4, browser, logresult);
		Thread.sleep(1000);*/
		
		rd.searchNotice(16, browser, logresult);
		Thread.sleep(2000);
		
		rd.updateNotice(4, browser, logresult);
		Thread.sleep(1000);
		
		rd.updateNotice(6, browser, logresult);
		Thread.sleep(1000);
		
		rd.updateNotice(8, browser, logresult);
		Thread.sleep(1000);
		
		rd.updateNotice(10, browser, logresult);
		Thread.sleep(3000);
		
		rd.searchNotice(16, browser, logresult);
		Thread.sleep(2000);
		
		rd.updateNotice(12, browser, logresult);
		Thread.sleep(1000);
