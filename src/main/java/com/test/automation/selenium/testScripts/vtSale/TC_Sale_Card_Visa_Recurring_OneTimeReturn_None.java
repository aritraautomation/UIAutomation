...
public class TC_Sale_Card_Visa_Recurring_OneTimeReturn_None {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		vt.vtAdditionalInformationOptional(14, browser, logresult);
		Thread.sleep(1000);
		
		vt.vtAdditionalInformationOptional(6, browser, logresult);
		Thread.sleep(1000);
