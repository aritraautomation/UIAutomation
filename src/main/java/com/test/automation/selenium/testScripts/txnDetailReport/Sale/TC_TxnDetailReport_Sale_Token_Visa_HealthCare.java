...
public class TC_TxnDetailReport_Sale_Token_Visa_HealthCare {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		txndtlrprt.vtHealthCare(4, browser, logresult);
		Thread.sleep(1000);
		...
		try{
			...
			browser.excel.storeCellData("TxnDetailReportSale_ReportHC", "text::"+txtHealthCareAccountType, 4, 3);
			
			txtPOSQualified = driver.findElement(By.xpath("//div[@id='posQualifiedList']/button/div/span")).getText();
			browser.excel.storeCellData("TxnDetailReportSale_ReportHC", "text::"+txtPOSQualified, 4, 7);
		...
		txndtlrprt.txnDetailReportHealthCare(4, browser, logresult);
		Thread.sleep(1000);
