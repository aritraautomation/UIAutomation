...
public class TC_ACH_ARC_WithoutCustomerNameButReceivingCompanyName {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		vt.vtRoutingAccountNumber(28, browser, logresult);
		Thread.sleep(1000);
		...
		/*try{
			...
			browser.excel.storeCellData("VTACH_Reports", "text::"+txtTxnID, 10, 8);
			...
			browser.excel.storeCellData("VTACH_Reports", "text::"+txtAccountNumber, 10, 10);
			...
			browser.excel.storeCellData("VTACH_Reports", "text::"+txtTxnMethod, 10, 13);
			...
			browser.excel.storeCellData("VTACH_Reports", "text::"+txtDateTime, 10, 7);
		...
		vt.vtACHReports(10, browser, logresult);
		Thread.sleep(1000);*/
