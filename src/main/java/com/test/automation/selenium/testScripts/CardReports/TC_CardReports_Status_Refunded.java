...
public class TC_CardReports_Status_Refunded {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("CardReports_Refund", txtTxnID, 5, 2);
		...
		cr.processRefundTxn(4, browser, logresult);
		Thread.sleep(1000);
		
		cr.processRefundTxn(6, browser, logresult);
		Thread.sleep(1000);
		
		cr.processRefundTxn(8, browser, logresult);
		Thread.sleep(1000);
		
		cr.processRefundTxn(10, browser, logresult);
		Thread.sleep(10000);
		...
		try{
			...
			browser.excel.storeCellData("CardReports_Reports", "text::"+txtDateTime, 16, 2);
			
			browser.excel.storeCellData("CardReports_Reports", "text::"+txtTxnID, 16, 4);
			
			txtCardNumber = driver.findElement(By.xpath("//td[contains(text(),'Card Number')]/../td[2]")).getText();
			browser.excel.storeCellData("CardReports_Reports", "text::"+txtCardNumber, 16, 7);
		...
		cr.processRefundTxn(12, browser, logresult);
		Thread.sleep(1000);
		
		cr.searchTransaction(4, browser, logresult);
		Thread.sleep(1000);
		
		cr.searchTransaction(34, browser, logresult);
		Thread.sleep(1000);
		
		cr.verifyCardReports(16, browser, logresult);
		Thread.sleep(1000);
