...
public class TC_RequestCheckToken_Same_MID_Same_AccountNumber {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			if(strTokenNumber1.equals(strTokenNumber2)){
				...
				logresult.logTest("Test Execution", "Status", "INFO", "First Check Token: "+strTokenNumber1+" and Second Check Token: "+strTokenNumber2, "Check Token is matching for same MID and same Account Number!!!", "");
			}
			
			else{
				
				logresult.logTest("Test Execution", "Status", "INFO", "First Check Token: "+strTokenNumber1+" and Second Check Token: "+strTokenNumber2, "Check Token is not matching for same MID and same Account Number!!!", "");
			}
