...
public class TC_CardReports_Status_Authorized {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("CardReports_Reports", "text::"+txtDateTime, 6, 2);
			
			browser.excel.storeCellData("CardReports_Reports", "text::"+txtTxnID, 6, 4);
			
			txtCardNumber = driver.findElement(By.xpath("//td[contains(text(),'Card Number')]/../td[2]")).getText();
			browser.excel.storeCellData("CardReports_Reports", "text::"+txtCardNumber, 6, 7);
		...
		cr.verifyCardReports(6, browser, logresult);
		Thread.sleep(1000);
