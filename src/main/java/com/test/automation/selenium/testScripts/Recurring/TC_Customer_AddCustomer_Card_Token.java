...
public class TC_Customer_AddCustomer_Card_Token {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("Recurring_CustomerAdd", txtTokenNumber, 27, 27);
			Thread.sleep(1000);
			}
			catch(Exception e){
		...
		rd.addCustomer(28, browser, logresult);
		Thread.sleep(1000);
