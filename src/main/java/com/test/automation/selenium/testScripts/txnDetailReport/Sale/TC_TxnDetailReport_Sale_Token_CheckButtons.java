...
public class TC_TxnDetailReport_Sale_Token_CheckButtons {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("TxnDetailReportSale_CheckButton", "text::"+txtTokenNumber, 6, 3);
		...
		try{
			...
			browser.excel.storeCellData("TxnDetailReportSale_Dashboard", "xpath:://table[@class='rtable']/tbody/tr[*]/td[2][text()='"+txtTxnID+"']/../td[7]/button", 1, 2);
			browser.excel.storeCellData("TxnDetailReportSale_CheckButton", "text::"+txtTxnID, 6, 2);
