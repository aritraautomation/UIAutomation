...
public class TC_VerifyCheckToken_Update_ActivateToSuspendToActive {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			token.updateCheckToken(8, browser, logresult);
			Thread.sleep(1000);
			...
			token.updateCheckToken(16, browser, logresult);
			Thread.sleep(1000);
			
			token.updateCheckToken(18, browser, logresult);
			Thread.sleep(1000);
			...
			token.updateCheckToken(20, browser, logresult);
			Thread.sleep(1000);
			...
			if(strTokenNumber1.equals(strTokenNumber2)){
				...
				logresult.logTest("Test Execution", "Status", "INFO", "First Card Token: "+strTokenNumber1+" and Second Card Token: "+strTokenNumber2, "Same Check Token got generated for updating Token from Active to Suspend to Active!!!", "");
			}
			
			else{
				
				logresult.logTest("Test Execution", "Status", "INFO", "First Card Token: "+strTokenNumber1+" and Second Card Token: "+strTokenNumber2, "Different Check Tokens got generated for updating Token from Active to Suspend to Active!!!", "");
			}
