...
public class TC_CardReports_UnsettledTxnReport {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("CardReports_Reports", "text::"+txtDateTime, 8, 2);
			
			browser.excel.storeCellData("CardReports_Reports", "text::"+txtTxnID, 8, 4);
			
			txtCardNumber = driver.findElement(By.xpath("//td[contains(text(),'Card Number')]/../td[2]")).getText();
			browser.excel.storeCellData("CardReports_Reports", "text::"+txtCardNumber, 8, 7);
		...
		cr.verifyCardReports(8, browser, logresult);
		Thread.sleep(1000);
