...
public class TC_ACHReports_Status_ReadyForPosting {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("ACHReports_Reports", "text::"+txtTxnID, 8, 4);
			browser.excel.storeCellData("ACHReports_AdminReview", "text::"+txtTxnID, 6, 3);
			browser.excel.storeCellData("ACHReports_ReadyForPosting", "text::"+txtTxnID, 6, 2);
			...
			browser.excel.storeCellData("ACHReports_Reports", "xpath:://table[@class='rtable']/tbody/tr[*]/td[3]/span[text()='"+txtTxnID+"']", 1, 4); //TxnID
			...
			browser.excel.storeCellData("ACHReports_Reports", "text::"+txtAccountNumber, 8, 6);
			
			txtTxnMethod = driver.findElement(By.xpath("//b[contains(text(),'Transaction Method')]/../../td[2]")).getText();
			browser.excel.storeCellData("ACHReports_Reports", "text::"+txtTxnMethod, 8, 9);
			...
			browser.excel.storeCellData("ACHReports_Reports", "text::"+txtDateTime, 8, 2);
			
			browser.excel.storeCellData("ACHReports_AdminReview", "xpath:://table[@class='rtable']/tbody/tr[*]/td[8]/span[text()='"+txtTxnID+"']", 1, 3); //TxnID
			browser.excel.storeCellData("ACHReports_AdminReview", "xpath:://table[@class='rtable']/tbody/tr[*]/td[8]/span[text()='"+txtTxnID+"']/../../td[1]", 1, 6); //Checkbox
			
			browser.excel.storeCellData("ACHReports_ReadyForPosting", "xpath:://table[@class='rtable']/tbody/tr[*]/td[8]/span[text()='"+txtTxnID+"']", 1, 2); //TxnID
			browser.excel.storeCellData("ACHReports_ReadyForPosting", "xpath:://table[@class='rtable']/tbody/tr[*]/td[8]/span[text()='"+txtTxnID+"']/../../td[1]", 1, 3); //Checkbox
		...
		ar.adminReview(4, browser, logresult);
		Thread.sleep(1000);
		
		ar.adminReview(6, browser, logresult);
		Thread.sleep(1000);
		
		ar.adminReview(8, browser, logresult);
		Thread.sleep(1000);
		
		ar.adminReview(10, browser, logresult);
		Thread.sleep(1000);
		
		ar.readyForPosting(4, browser, logresult);
		Thread.sleep(1000);
		
		ar.readyForPosting(6, browser, logresult);
		Thread.sleep(1000);
		
		ar.readyForPosting(8, browser, logresult);
		Thread.sleep(1000);
		
		ar.readyForPosting(10, browser, logresult);
		Thread.sleep(1000);
		
		ar.searchTransaction(4, browser, logresult);
		Thread.sleep(1000);
		
		ar.searchTransaction(30, browser, logresult);
		Thread.sleep(1000);
		
		ar.verifyACHReports(8, browser, logresult);
		Thread.sleep(1000);
