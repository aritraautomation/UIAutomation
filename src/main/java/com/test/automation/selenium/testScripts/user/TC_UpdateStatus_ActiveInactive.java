...
public class TC_UpdateStatus_ActiveInactive {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			user.userSearch(12, browser, logresult);
			Thread.sleep(1000);
			
			user.userSearch(10, browser, logresult);
			Thread.sleep(1000);
			
			user.verifyUserDetail(10, browser, logresult);
			Thread.sleep(1000);
			
			user.userSearch(6, browser, logresult);
			Thread.sleep(1000);
			
			user.userActiveInactive(4, browser, logresult);
			Thread.sleep(1000);
			
			user.userActiveInactive(6, browser, logresult);
			Thread.sleep(1000);
			
			user.userActiveInactive(8, browser, logresult);
			Thread.sleep(1000);
			
			user.userSearch(14, browser, logresult);
			Thread.sleep(1000);
			
			user.userSearch(10, browser, logresult);
			Thread.sleep(1000);
			
			user.verifyUserDetail(12, browser, logresult);
			Thread.sleep(1000);
