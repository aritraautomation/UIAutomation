package com.test.automation.selenium.testScripts.Extra;
...
public class TC_SearchUser {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("User_Search", txtUsername, 27, 3);
			...
			user.userSearch(26, browser, logresult);
			Thread.sleep(1000);
			
			for(int i=0; i<3; i++){
				
				user.userSearch(28, browser, logresult);
				Thread.sleep(1000);
