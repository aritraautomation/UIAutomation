...
public class TC_VerifyMessage_SameMID_OtherUser {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		msg.addMessage(22, browser, logresult);
		Thread.sleep(1000);
		...
		login.goBackToLoginAgain(4);
		Thread.sleep(2000);
		
		login.goBackToLoginAgain(8);
		Thread.sleep(4000);
		...
		login.goBackToLoginAgain(6);
		Thread.sleep(4000);
		
		msg.addMessage(4, browser, logresult);
		Thread.sleep(1000);
		
		msg.addMessage(28, browser, logresult);
		Thread.sleep(1000);
