...
public class TC_Notice_SearchNotice_ContractNumber {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("Recurring1_NoticeSearch", txtContractNo, 17, 1);
			...
			browser.excel.storeCellData("Recurring1_NoticeSearch", "text::"+txtContractNo, 6, 4);
			Thread.sleep(1000);
			}
			catch(Exception e){
				logresult.logTest("Test Execution", "Status", "INFO", "Exception occurred!!!", e.getMessage(), "");
		...
		rd.searchNotice(18, browser, logresult);
		Thread.sleep(3000);
		
		rd.searchNotice(6, browser, logresult);
		Thread.sleep(1000);
