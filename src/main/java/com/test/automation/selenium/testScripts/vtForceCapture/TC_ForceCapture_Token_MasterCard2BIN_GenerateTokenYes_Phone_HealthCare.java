...
public class TC_ForceCapture_Token_MasterCard2BIN_GenerateTokenYes_Phone_HealthCare {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		vt.vtRequestCardToken(14, browser, logresult);
		Thread.sleep(1000);
		...
		vt.vtToken(24, browser, logresult);
		Thread.sleep(1000);
		
		vt.vtHealthCare(6, browser, logresult);
		Thread.sleep(1000);
		...
		/*try{
			...
			browser.excel.storeCellData("VTForceCapture_Dashboard", "xpath:://table[@class='rtable1']/tbody/tr[*]/td[2][text()='"+txtTxnID+"']", 1, 3);
			browser.excel.storeCellData("VTForceCapture_Dashboard", "text::"+txtTxnID, 6, 3);
			browser.excel.storeCellData("VTForceCapture_CardReports", txtTxnID, 5, 5);
			browser.excel.storeCellData("VTForceCapture_CardReports", "text::"+txtTxnID, 8, 8);
			
			txtCardNumber = driver.findElement(By.xpath("//td[contains(text(),'Card Number')]/../td[2]")).getText();
			browser.excel.storeCellData("VTForceCapture_Dashboard", "xpath:://table[@class='rtable1']/tbody/tr[*]/td[2][text()='"+txtTxnID+"']/../td[1]", 1, 2);
			browser.excel.storeCellData("VTForceCapture_Dashboard", "text::"+txtCardNumber, 6, 2);
			browser.excel.storeCellData("VTForceCapture_CardReports", "text::"+txtCardNumber, 8, 10);
			
			browser.excel.storeCellData("VTForceCapture_Dashboard", "xpath:://table[@class='rtable1']/tbody/tr[*]/td[2][text()='"+txtTxnID+"']/../td[3]", 1, 4);
			
			txtPaymentType = driver.findElement(By.xpath("//td[contains(text(),'Payment Type')]/../td[2]")).getText();
			browser.excel.storeCellData("VTForceCapture_CardReports", "text::"+txtPaymentType, 8, 11);
			
			txtDate = driver.findElement(By.xpath("//td[contains(text(),'Date')]/../td[2]")).getText();
			browser.excel.storeCellData("VTForceCapture_Dashboard", "xpath:://table[@class='rtable1']/tbody/tr[*]/td[2][text()='"+txtTxnID+"']/../td[4]", 1, 5);
			...
			browser.excel.storeCellData("VTForceCapture_Dashboard", "xpath:://table[@class='rtable1']/tbody/tr[*]/td[2][text()='"+txtTxnID+"']/../td[5]", 1, 6);
			browser.excel.storeCellData("VTForceCapture_Dashboard", "text::"+txtTime, 6, 6);
			
			browser.excel.storeCellData("VTForceCapture_Dashboard", "xpath:://table[@class='rtable1']/tbody/tr[*]/td[2][text()='"+txtTxnID+"']/../td[6]", 1, 7);
			
			txtDateTime = txtDate+" "+txtTime;
			browser.excel.storeCellData("VTForceCapture_CardReports", "text::"+txtDateTime, 8, 7);
