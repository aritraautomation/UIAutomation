...
public class TC_UpdateSuspendCardToken_ExpiryDateBlank {
	...
	public static WebElement txtExpiryDate = null;
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			try{
				driver=browser.driver;
				txtExpiryDate = driver.findElement(By.id("update_exp_date"));
				txtExpiryDate.sendKeys(Keys.chord(Keys.CONTROL,"a",Keys.DELETE));
				txtExpiryDate.sendKeys(Keys.chord(Keys.CONTROL,"a",Keys.DELETE));
				Thread.sleep(1000);
				}
				catch(Exception e){
			...
			token.updateCardToken(28, browser, logresult);
			Thread.sleep(1000);
			...
			token.updateCardToken(30, browser, logresult);
			Thread.sleep(1000);
