...
public class TC_Customer_AddDuplicateCustomer_DifferentMID {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		rd.addCustomer(46, browser, logresult);
		Thread.sleep(1000);
		...
		try{
			...
			browser.excel.storeCellData("Recurring_CustomerAdd", txtCustomerNo, 49, 3);
		...
		rd.addCustomer(50, browser, logresult);
		Thread.sleep(1000);
