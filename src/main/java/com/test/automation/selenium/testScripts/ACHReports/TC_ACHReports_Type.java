...
public class TC_ACHReports_Type {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		ar.processTxn(14, browser, logresult);
		Thread.sleep(1000);
		...
		try{
			...
			if(rdTxnTypeDebit.isSelected()){
				...
				txtTxnType = "DR";
				browser.excel.storeCellData("ACHReports_Search", txtTxnType, 21, 14);
				browser.excel.storeCellData("ACHReports_Reports", "text::"+txtTxnType, 4, 8);
			}
		...
		ar.processTxn(16, browser, logresult);
		Thread.sleep(10000);
		...
		ar.searchTransaction(22, browser, logresult);
		Thread.sleep(1000);
