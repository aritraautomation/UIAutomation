...
public class TC_Notice_AddNotice_EmailTypeContractEnd_Suspend {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("Recurring1_NoticeAdd", txtContractNo, 23, 3);
		...
		rd.addNotice(24, browser, logresult);
		Thread.sleep(1000);
