...
public class TC_CardReports_SettledTxnReport {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("CardReports_Reports", "text::"+txtDateTime, 10, 2);
			
			browser.excel.storeCellData("CardReports_Reports", "text::"+txtTxnID, 10, 4);
			
			txtCardNumber = driver.findElement(By.xpath("//td[contains(text(),'Card Number')]/../td[2]")).getText();
			browser.excel.storeCellData("CardReports_Reports", "text::"+txtCardNumber, 10, 7);
		...
		cr.verifyCardReports(10, browser, logresult);
		Thread.sleep(1000);
