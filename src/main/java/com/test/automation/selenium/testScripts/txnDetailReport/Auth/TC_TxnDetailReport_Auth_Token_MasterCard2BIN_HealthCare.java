...
public class TC_TxnDetailReport_Auth_Token_MasterCard2BIN_HealthCare {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("TxnDetailReportAuth_ReportHC", "text::"+txtHealthCareAccountType, 6, 3);
			
			txtPOSQualified = driver.findElement(By.xpath("//div[@id='posQualifiedList']/button/div/span")).getText();
			browser.excel.storeCellData("TxnDetailReportAuth_ReportHC", "text::"+txtPOSQualified, 6, 7);
		...
		txndtlrprt.txnDetailReportHealthCare(6, browser, logresult);
		Thread.sleep(1000);
