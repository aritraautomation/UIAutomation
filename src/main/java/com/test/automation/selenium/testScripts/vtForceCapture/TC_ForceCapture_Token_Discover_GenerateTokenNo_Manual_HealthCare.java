...
public class TC_ForceCapture_Token_Discover_GenerateTokenNo_Manual_HealthCare {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		vt.vtRequestCardToken(18, browser, logresult);
		Thread.sleep(1000);
		...
		vt.vtToken(26, browser, logresult);
		Thread.sleep(1000);
		
		vt.vtHealthCare(8, browser, logresult);
		Thread.sleep(1000);
