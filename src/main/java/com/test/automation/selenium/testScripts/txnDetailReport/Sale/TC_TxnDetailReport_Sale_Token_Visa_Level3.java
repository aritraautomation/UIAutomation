...
public class TC_TxnDetailReport_Sale_Token_Visa_Level3 {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		txndtlrprt.vtRequestCardToken(8, browser, logresult);
		Thread.sleep(1000);
		...
		txndtlrprt.vtLevel3(4, browser, logresult);
		Thread.sleep(1000);
		...
		txndtlrprt.txnDetailReportLevel3(4, browser, logresult);
		Thread.sleep(1000);
