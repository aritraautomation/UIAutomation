...
public class TC_TxnDetailReport_Multiple_Refund_Card_AMEX {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("TxnDetailReportRefund_Report", "text::"+txtExpDate, 6, 5);
		...
		txndtlrprt.vtRefund(16, browser, logresult);
		Thread.sleep(10000);
		...
		try{
			...
			browser.excel.storeCellData("TxnDetailReportRefund_Report", "text::"+txtTxnID, 6, 14);
			...
			browser.excel.storeCellData("TxnDetailReportRefund_Report", "text::"+txtCardNumber, 6, 4);
			
			txtDOP = driver.findElement(By.xpath("//td[contains(text(),'Description of purchase')]/../td[2]")).getText();
			browser.excel.storeCellData("TxnDetailReportRefund_Report", "text::"+txtDOP, 6, 6);
			
			txtPaymentType = driver.findElement(By.xpath("//td[contains(text(),'Payment Type')]/../td[2]")).getText();
			browser.excel.storeCellData("TxnDetailReportRefund_Report", "text::"+txtPaymentType, 6, 7);
			
			txtAuthCode = driver.findElement(By.xpath("//td[contains(text(),'Auth Code')]/../td[2]")).getText();
			browser.excel.storeCellData("TxnDetailReportRefund_Report", "text::"+txtAuthCode, 6, 15);
			...
			browser.excel.storeCellData("TxnDetailReportRefund_Report", "text::"+txtDateTime, 6, 22);
		...
		txndtlrprt.vtRefund(18, browser, logresult);
		Thread.sleep(10000);
		...
		try{
			...
			txtTxnID = driver.findElement(By.id("transaction_id")).getText();
			browser.excel.storeCellData("TxnDetailReportRefund_Dashboard", "xpath:://table[contains(@class,'rtable1')]/tbody/tr[*]/td[2][text()='"+txtTxnID+"']/../td[7]/button", 1, 2);
			browser.excel.storeCellData("TxnDetailReportRefund_Report", "text::"+txtTxnID, 8, 14);
			browser.excel.storeCellData("TxnDetailReportRefund_CardRprt", txtTxnID, 5, 5);
			
			txtCardNumber = driver.findElement(By.xpath("//td[contains(text(),'Card Number')]/../td[2]")).getText();
			browser.excel.storeCellData("TxnDetailReportRefund_Report", "text::"+txtCardNumber, 8, 4);
			
			txtDOP = driver.findElement(By.xpath("//td[contains(text(),'Description of purchase')]/../td[2]")).getText();
			browser.excel.storeCellData("TxnDetailReportRefund_Report", "text::"+txtDOP, 8, 6);
			
			txtPaymentType = driver.findElement(By.xpath("//td[contains(text(),'Payment Type')]/../td[2]")).getText();
			browser.excel.storeCellData("TxnDetailReportRefund_Report", "text::"+txtPaymentType, 8, 7);
			
			txtAuthCode = driver.findElement(By.xpath("//td[contains(text(),'Auth Code')]/../td[2]")).getText();
			browser.excel.storeCellData("TxnDetailReportRefund_Report", "text::"+txtAuthCode, 8, 15);
			
			txtDate = driver.findElement(By.xpath("//div[@id='customer_recipt']/table//tbody/tr[8]/td[2]")).getText();
			txtTime = driver.findElement(By.xpath("//div[@id='customer_recipt']/table//tbody/tr[9]/td[2]")).getText();
			txtDateTime = txtDate+" "+txtTime;
			browser.excel.storeCellData("TxnDetailReportRefund_Report", "text::"+txtDateTime, 8, 22);
		...
		txndtlrprt.txnDetailReport(8, browser, logresult);
		Thread.sleep(1000);
		
		txndtlrprt.vtCardReports(10, browser, logresult);
		Thread.sleep(1000);
