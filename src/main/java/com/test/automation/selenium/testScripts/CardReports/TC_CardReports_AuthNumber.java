...
public class TC_CardReports_AuthNumber {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		cr.processForceCaptureTxn(4, browser, logresult);
		Thread.sleep(1000);
		
		cr.processForceCaptureTxn(6, browser, logresult);
		Thread.sleep(1000);
		
		cr.processForceCaptureTxn(8, browser, logresult);
		Thread.sleep(10000);
		...
		cr.processForceCaptureTxn(10, browser, logresult);
		Thread.sleep(1000);
		
		cr.searchTransaction(4, browser, logresult);
		Thread.sleep(1000);
		
		cr.searchTransaction(24, browser, logresult);
		Thread.sleep(1000);
