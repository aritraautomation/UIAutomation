...
public class TC_TxnDetailReport_ForceCapture_Card_MasterCard2BIN_Level3 {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		txndtlrprt.vtCard(16, browser, logresult);
		Thread.sleep(1000);
		...
		try{
			...
			browser.excel.storeCellData("TxnDetailReportFC_ReportNone", "text::"+txtExpDate, 4, 5);
			...
			if (txtDataSource.equals("MANUAL")){
				...
				browser.excel.storeCellData("TxnDetailReportFC_ReportNone", "text::"+txtDataSource, 4, 11);
			}
			else{
				browser.excel.storeCellData("TxnDetailReportFC_ReportNone", "text::"+txtDataSource, 4, 11);				
			}
		...
		try{
			...
			browser.excel.storeCellData("TxnDetailReportFC_ReportL3", "text::"+txtTaxCategory, 6, 4);
			
			txtMeasurementUnit = driver.findElement(By.xpath("//div[@id='measurementUnit']/button/div/span")).getText();
			browser.excel.storeCellData("TxnDetailReportFC_ReportL3", "text::"+txtMeasurementUnit, 6, 18);
		...
		try{
			...
			browser.excel.storeCellData("TxnDetailReportFC_ReportNone", "text::"+txtTxnID, 4, 14);
			...
			browser.excel.storeCellData("TxnDetailReportFC_ReportNone", "text::"+txtCardNumber, 4, 4);
			
			txtPaymentType = driver.findElement(By.xpath("//td[contains(text(),'Payment Type')]/../td[2]")).getText();
			browser.excel.storeCellData("TxnDetailReportFC_ReportNone", "text::"+txtPaymentType, 4, 7);
			
			txtAuthCode = driver.findElement(By.xpath("//td[contains(text(),'Auth Code')]/../td[2]")).getText();
			browser.excel.storeCellData("TxnDetailReportFC_ReportNone", "text::"+txtAuthCode, 4, 15);
			...
			browser.excel.storeCellData("TxnDetailReportFC_ReportNone", "text::"+txtDateTime, 4, 23);
