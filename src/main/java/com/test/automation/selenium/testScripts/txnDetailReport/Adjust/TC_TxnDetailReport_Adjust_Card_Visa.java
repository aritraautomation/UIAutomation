...
public class TC_TxnDetailReport_Adjust_Card_Visa {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("TxnDetailReportAdjust_Report", "text::"+txtExpDate, 4, 5);
			...
			if (txtDataSource.equals("MANUAL")){
				...
				browser.excel.storeCellData("TxnDtlReportAdjust_Report", "text::"+txtDataSource, 4, 11);
			}
			else{
				browser.excel.storeCellData("TxnDtlReportAdjust_Report", "text::"+txtDataSource, 4, 11);				
			}
		...
		try{
			...
			browser.excel.storeCellData("TxnDtlReportAdjust_Report", "text::"+txtTxnID, 4, 14);
			...
			browser.excel.storeCellData("TxnDtlReportAdjust_Report", "text::"+txtCardNumber, 4, 4);
			
			txtPaymentType = driver.findElement(By.xpath("//td[contains(text(),'Payment Type')]/../td[2]")).getText();
			browser.excel.storeCellData("TxnDtlReportAdjust_Report", "text::"+txtPaymentType, 4, 7);
			
			txtAuthCode = driver.findElement(By.xpath("//td[contains(text(),'Auth Code')]/../td[2]")).getText();
			browser.excel.storeCellData("TxnDtlReportAdjust_Report", "text::"+txtAuthCode, 4, 15);
			...
			browser.excel.storeCellData("TxnDtlReportAdjust_Report", "text::"+txtDateTime, 4, 23);
