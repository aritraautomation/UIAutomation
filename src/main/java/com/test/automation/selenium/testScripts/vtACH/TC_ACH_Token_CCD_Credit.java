...
public class TC_ACH_Token_CCD_Credit {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		vt.vtRequestACHToken(4, browser, logresult);
		Thread.sleep(1000);
		
		vt.vtRequestACHToken(6, browser, logresult);
		Thread.sleep(1000);
		
		vt.vtRequestACHToken(8, browser, logresult);
		Thread.sleep(1000);
		
		vt.vtRequestACHToken(10, browser, logresult);
		Thread.sleep(1000);
		
		vt.vtACHToken(4, browser, logresult);
		Thread.sleep(1000);
		
		vt.vtACHToken(6, browser, logresult);
		Thread.sleep(1000);
		...
		vt.vtACHToken(16, browser, logresult);
		Thread.sleep(1000);
		...
		vt.vtACHToken(26, browser, logresult);
		Thread.sleep(1000);
		
		vt.vtACHToken(10, browser, logresult);
		Thread.sleep(1000);
		...
		vt.vtACHToken(12, browser, logresult);
		Thread.sleep(1000);
