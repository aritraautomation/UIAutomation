...
public class TC_ACHReports_Status_AdminReview {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("ACHReports_Reports", "text::"+txtTxnID, 6, 4);
			...
			browser.excel.storeCellData("ACHReports_Reports", "text::"+txtAccountNumber, 6, 6);
			
			txtTxnMethod = driver.findElement(By.xpath("//b[contains(text(),'Transaction Method')]/../../td[2]")).getText();
			browser.excel.storeCellData("ACHReports_Reports", "text::"+txtTxnMethod, 6, 9);
			...
			browser.excel.storeCellData("ACHReports_Reports", "text::"+txtDateTime, 6, 2);
		...
		ar.searchTransaction(28, browser, logresult);
		Thread.sleep(1000);
		
		ar.verifyACHReports(6, browser, logresult);
		Thread.sleep(1000);
