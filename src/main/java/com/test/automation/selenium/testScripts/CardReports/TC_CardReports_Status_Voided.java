...
public class TC_CardReports_Status_Voided {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("CardReports_Void", txtTxnID, 5, 2);
		...
		cr.processVoidTxn(4, browser, logresult);
		Thread.sleep(1000);
		
		cr.processVoidTxn(6, browser, logresult);
		Thread.sleep(1000);
		
		cr.processVoidTxn(8, browser, logresult);
		Thread.sleep(1000);
		
		cr.processVoidTxn(10, browser, logresult);
		Thread.sleep(10000);
		...
		try{
			...
			browser.excel.storeCellData("CardReports_Reports", "text::"+txtDateTime, 18, 2);
			
			browser.excel.storeCellData("CardReports_Reports", "text::"+txtTxnID, 18, 4);
			
			txtCardNumber = driver.findElement(By.xpath("//td[contains(text(),'Card Number')]/../td[2]")).getText();
			browser.excel.storeCellData("CardReports_Reports", "text::"+txtCardNumber, 18, 7);
		...
		cr.processVoidTxn(12, browser, logresult);
		Thread.sleep(1000);
		
		cr.searchTransaction(4, browser, logresult);
		Thread.sleep(1000);
		
		cr.searchTransaction(32, browser, logresult);
		Thread.sleep(1000);
		
		cr.verifyCardReports(18, browser, logresult);
		Thread.sleep(1000);
