...
public class TC_Customer_UpdateCustomerStatus_SuspendToActive {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		rd.addCustomer(14, browser, logresult);
		Thread.sleep(1000);
		...
		rd.updateCustomer(10, browser, logresult);
		Thread.sleep(2000);
		
		rd.updateCustomer(12, browser, logresult);
		Thread.sleep(2000);
		...
		rd.updateCustomer(4, browser, logresult);
		Thread.sleep(2000);
