...
public class TC_TxnDetailReport_Sale_Token_MasterCard2BIN_Level2 {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		txndtlrprt.vtLevel2(4, browser, logresult);
		Thread.sleep(10000);
		...
		txndtlrprt.txnDetailReportLevel2(4, browser, logresult);
		Thread.sleep(1000);
