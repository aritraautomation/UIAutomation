...
public class TC_Notice_AddNotice_EmailTypeContractCancel_Active {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("Recurring1_NoticeAdd", txtContractNo, 17, 3);
		...
		rd.addNotice(18, browser, logresult);
		Thread.sleep(1000);
