...
public class TC_RequestCardToken_Same_MID_Same_Card_Suspended_Token {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			if(strTokenNumber1.equals(strTokenNumber2)){
				...
				logresult.logTest("Test Execution", "Status", "INFO", "First Card Token: "+strTokenNumber1+" and Second Card Token: "+strTokenNumber2, "Same Card Token got generated for same MID and same Card Number but suspended Token!!!", "");
			}
			
			else{
				
				logresult.logTest("Test Execution", "Status", "INFO", "First Card Token: "+strTokenNumber1+" and Second Card Token: "+strTokenNumber2, "Different Card Tokens got generated for same MID and same Card Number but suspended Token!!!", "");
			}
