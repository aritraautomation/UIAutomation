...
public class TC_AVSCity_Decline_Unmatched {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		fms.avsCity(4, browser, logresult);
		Thread.sleep(1000);
		
		fms.avsCity(6, browser, logresult);
		Thread.sleep(1000);
		
		fms.avsCity(8, browser, logresult);
		Thread.sleep(1000);
		
		fms.avsCity(10, browser, logresult);
		Thread.sleep(1000);
		
		fms.avsCity(12, browser, logresult);
		Thread.sleep(1000);
		
		fms.vtSale(4, browser, logresult);
		Thread.sleep(1000);
		
		fms.vtSale(20, browser, logresult);
		Thread.sleep(1000);
		...
		fms.avsCity(14, browser, logresult);
		Thread.sleep(1000);
		
		fms.avsCity(16, browser, logresult);
		Thread.sleep(1000);
		
		fms.avsCity(18, browser, logresult);
		Thread.sleep(1000);
		
		fms.avsCity(20, browser, logresult);
		Thread.sleep(1000);
