...
public class TC_TxnDetailReport_ForceCapture_Token_CheckButtons {
	...
	public void ExecuteTest(String browserType, String strProgramDetails, String strTestEnvDetails, logResult result) throws Exception 
	{
		...
		try{
			...
			browser.excel.storeCellData("TxnDetailReportFC_CheckButton", "text::"+txtTokenNumber, 6, 3);
		...
		try{
			...
			browser.excel.storeCellData("TxnDetailReportFC_CheckButton", "text::"+txtTxnID, 6, 2);
