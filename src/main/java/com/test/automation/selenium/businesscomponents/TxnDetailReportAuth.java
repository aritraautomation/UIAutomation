...
public class TxnDetailReportAuth {
	...
	public void vtCard(int rownum, Browser bwr, logResult result){
		...
		try {
			...
			browser.InputData("TxnDetailReportAuth_Card", intRowNum);
			Thread.sleep(2000);
	...
	public void vtRequestCardToken(int rownum, Browser bwr, logResult result){
		...
		try {
			...
			browser.InputData("TxnDetailReportAuth_ReqToken", intRowNum);
			Thread.sleep(2000);
	...
	public void vtToken(int rownum, Browser bwr, logResult result){
		...
		try {
			...
			browser.InputData("TxnDetailReportAuth_Token", intRowNum);
			Thread.sleep(2000);
	...
	public void vtHealthCare(int rownum, Browser bwr, logResult result){
		...
		try {
			...
			browser.InputData("TxnDetailReportAuth_HealthCare", intRowNum);
			Thread.sleep(2000);
	...
	public void vtLevel2(int rownum, Browser bwr, logResult result){
		...
		try {
			...
			browser.InputData("TxnDetailReportAuth_Level2", intRowNum);
			Thread.sleep(2000);
	...
	public void vtLevel3(int rownum, Browser bwr, logResult result){
		...
		try {
			...
			browser.InputData("TxnDetailReportAuth_Level3", intRowNum);
			Thread.sleep(2000);
	...
	public void vtDashboard(int rownum, Browser bwr, logResult result){
		...
		try {
			...
			browser.InputData("TxnDetailReportAuth_Dashboard", intRowNum);
			Thread.sleep(2000);
	...
	public void vtCardReports(int rownum, Browser bwr, logResult result){
		...
		try {
			...
			browser.InputData("TxnDetailReportAuth_CardReports", intRowNum);
			Thread.sleep(2000);
	...
	public void txnDetailReportNone(int rownum, Browser bwr, logResult result){
		...
		try {
			...
			browser.InputData("TxnDetailReportAuth_ReportNone", intRowNum);
			Thread.sleep(2000);
	...
	public void txnDetailReportHealthCare(int rownum, Browser bwr, logResult result){
		...
		try {
			...
			browser.InputData("TxnDetailReportAuth_ReportHC", intRowNum);
			Thread.sleep(2000);
	...
	public void txnDetailReportLevel2(int rownum, Browser bwr, logResult result){
		...
		try {
			...
			browser.InputData("TxnDetailReportAuth_ReportL2", intRowNum);
			Thread.sleep(2000);
	...
	public void txnDetailReportLevel3(int rownum, Browser bwr, logResult result){
		...
		try {
			...
			browser.InputData("TxnDetailReportAuth_ReportL3", intRowNum);
			Thread.sleep(2000);
	...
	public void txnDetailReportCheckButton(int rownum, Browser bwr, logResult result){
		...
		try {
			...
			browser.InputData("TxnDetailReportAuth_CheckButton", intRowNum);
			Thread.sleep(2000);
