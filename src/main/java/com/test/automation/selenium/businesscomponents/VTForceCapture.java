...
public class VTForceCapture {
	...
	public void vtCard(int rownum, Browser bwr, logResult result){
		...
		try {
			...
			browser.InputData("VTForceCapture_Card", intRowNum);
			Thread.sleep(2000);
	...
	public void vtRequestCardToken(int rownum, Browser bwr, logResult result){
		...
		try {
			...
			browser.InputData("VTForceCapture_RequestCardToken", intRowNum);
			Thread.sleep(2000);
	...
	public void vtToken(int rownum, Browser bwr, logResult result){
		...
		try {
			...
			browser.InputData("VTForceCapture_Token", intRowNum);
			Thread.sleep(2000);
	...
	public void vtHealthCare(int rownum, Browser bwr, logResult result){
		...
		try {
			...
			browser.InputData("VTForceCapture_HealthCare", intRowNum);
			Thread.sleep(2000);
	...
	public void vtLevel2(int rownum, Browser bwr, logResult result){
		...
		try {
			...
			browser.InputData("VTForceCapture_Level2", intRowNum);
			Thread.sleep(2000);
	...
	public void vtLevel3(int rownum, Browser bwr, logResult result){
		...
		try {
			...
			browser.InputData("VTForceCapture_Level3", intRowNum);
			Thread.sleep(2000);
	...
	public void vtDownload(int rownum, Browser bwr, logResult result){
		...
		try {
			...
			browser.InputData("VTForceCapture_Download", intRowNum);
			Thread.sleep(2000);
	...
	public void vtDashboard(int rownum, Browser bwr, logResult result){
		...
		try {
			...
			browser.InputData("VTForceCapture_Dashboard", intRowNum);
			Thread.sleep(2000);
	...
	public void vtCardReports(int rownum, Browser bwr, logResult result){
		...
		try {
			...
			browser.InputData("VTForceCapture_CardReports", intRowNum);
			Thread.sleep(2000);
	...
	public void vtVerifyOptionalInformation(int rownum, Browser bwr, logResult result){
		...
		try {
			...
			browser.InputData("VTForceCapture_OptionalInfo", intRowNum);
			Thread.sleep(2000);
